...
public final class ModProjectiles {
	...
	public static final ConfiguredProjectile<ImpalerProjectile> IMPALER_PROJECTILE = create("Impaler Projectile", 2f, 20f, 2, 0.95f, ModSoundEvents.IMPALER_SHOOT.get(), ImpalerProjectile::new);
