...
public final class ModBlocks {
	...
	public static final RegistryObject<WaterGelBlock> WATER_GEL_BLOCK = register("water_gel_block", properties -> new WaterGelBlock(properties.mapColor(MapColor.WATER).strength(0.5f, 100f).speedFactor(0.8f).jumpFactor(1.2f).noOcclusion().forceSolidOn().sound(ModSoundTypes.GEL_BLOCK).isRedstoneConductor(ModBlocks::neverValid)));
