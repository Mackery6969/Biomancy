...
public class ModEntityLoot extends EntityLootSubProvider {
	...
	private LootTable.Builder fleshBlobLootTableBuilderWithDrop(int rolls) {
		return LootTable.lootTable()
				...
				.withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1)).add(NestedLootTable.lootTableReference(ModEntityTypes.FLESH_BLOB.get().getDefaultLootTable())));
	}
	...
	private LootTable.Builder fleshBlobLootTable() {
		return LootTable.lootTable()
				.withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1)).add(LootItem.lootTableItem(ModItems.LIVING_FLESH.get())
						.apply(SetItemCountFunction.setCount(ConstantValue.exactly(1))).apply(EnchantedCountIncreaseFunction.lootingMultiplier(this.registries, UniformGenerator.between(0f, 1f)))))
	...
	private LootTable.Builder unshornFleshSheepLootTable() {
		return LootTable.lootTable()
				...
				.withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1)).add(LootItem.lootTableItem(Items.STRING)
						.apply(SetItemCountFunction.setCount(UniformGenerator.between(0, 2)))))
				.withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1)).add(NestedLootTable.lootTableReference(ModEntityTypes.FLESH_SHEEP.get().getDefaultLootTable())));
	}
	...
	public void generate() {
		...
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_2), fleshBlobLootTableBuilderWithDrop(1));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_3), fleshBlobLootTableBuilderWithDrop(2));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_4), fleshBlobLootTableBuilderWithDrop(3));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_5), fleshBlobLootTableBuilderWithDrop(4));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_6), fleshBlobLootTableBuilderWithDrop(5));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_7), fleshBlobLootTableBuilderWithDrop(6));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_8), fleshBlobLootTableBuilderWithDrop(7));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_9), fleshBlobLootTableBuilderWithDrop(8));
		add(ModEntityTypes.FLESH_BLOB.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_BLOB_SIZE_10), fleshBlobLootTableBuilderWithDrop(9));
		...
		add(ModEntityTypes.FLESH_SHEEP.get(), ResourceKey.create(Registries.LOOT_TABLE, ModLoot.Entity.FLESH_SHEEP_UNSHORN), unshornFleshSheepLootTable());
	...
	protected Stream<EntityType<?>> getKnownEntityTypes() {
		Stream<EntityType<?>> entityTypes = ModEntityTypes.ENTITIES.getEntries().stream().map(holder -> (EntityType<?>) holder.get());
